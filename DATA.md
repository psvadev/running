...
| `stravaId` | string? | The Strava activity id this session was filled from. Set only on sessions populated via "Hent fra Strava" **from 2026-07 onward** — older and manually-entered sessions have none. Enables the edit-form "Oppdater fra Strava" button (re-pull the same activity by id). Not used in any computation. |
