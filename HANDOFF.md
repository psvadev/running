...
- `.dash-grid > * { min-width: 0; overflow: hidden }` — constrains dashboard cards so Chart.js sizes charts to the card width, not to overflowing content
