...
- `let paceUnit = 'pace'` — global unit toggle for all pace charts ('pace'=min/km / 'kmh'=km/t); radio buttons in dashboard filter bar; re-renders Z2Pace and PaceHr charts on change
